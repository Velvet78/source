...
unsigned int nStakeMinAge = 1 * nOneHour; // 1 hour as zero time weight
...
const string strMessageMagic = "Rubble Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Rubble
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // Rubble: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Rubble", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Rubble Genesis";
        CTransaction txNew;
        txNew.nTime = 1462734150;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1462734159;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2105448 : 1042227;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x156379e6c6eb044a4a738e2214691b7e4822e0e2d0371b8fa00e308ddcfe94bd"));
...
unsigned char pchMessageStart[4] = { 0xb4, 0xd8, 0xa2, 0xe5 };
