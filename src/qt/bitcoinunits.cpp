...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Rubbles"));
    case mBTC: return QString(QObject::tr("Milli-Rubbles (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Rubbles (1 / 1,000,000)"));
    default: return QString("???");
    }
}
